...
0000000000400f43 <phase_3>:
  ...
  400f60:	83 f8 01             	cmp    $0x1,%eax;num of input
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp);rsp point to ipt
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>;>7 or <0
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax;eax-*(rsp+12)
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>
  400fc4:	e8 71 04 00 00       	callq  40143a <explode_bomb>
  400fc9:	48 83 c4 18          	add    $0x18,%rsp
  400fcd:	c3                   	retq   

0000000000400fce <func4>:				 ;edx=14 esi=0 edi=ipt1
  400fce:	48 83 ec 08          	sub    $0x8,%rsp
  400fd2:	89 d0                	mov    %edx,%eax
  400fd4:	29 f0                	sub    %esi,%eax 
  400fd6:	89 c1                	mov    %eax,%ecx ;ecx=edx-esi
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx;ecx=1(edx<esi),0(>=)
  400fdb:	01 c8                	add    %ecx,%eax
  400fdd:	d1 f8                	sar    %eax     	;eax/=2
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx;ecx=rax+rsi
  400fe2:	39 f9                	cmp    %edi,%ecx        ;edi=1st input
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>
					;1st input >7
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx  ;edx=6
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>
  400fee:	01 c0                	add    %eax,%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>
					;1st input <=7
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax  ;
  400ff7:	39 f9                	cmp    %edi,%ecx  ;7-ipt1
  400ff9:	7d 0c                	jge    401007 <func4+0x39>;ipt1<=7 ret
...
000000000040100c <phase_4>:
  ...
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp);1st input <= 14
...
00000000004010f4 <phase_6>:
  ...
  401114:	4c 89 ed             	mov    %r13,%rbp ;r13 p to ipt+i*4
  ...
  401130:	74 21                	je     401153 <phase_6+0x5f>;out loop(6)
  ...
  401158:	4c 89 f0             	mov    %r14,%rax	;rax p ipt
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx
  401160:	89 ca                	mov    %ecx,%edx
  401162:	2b 10                	sub    (%rax),%edx	;edx=7-1st
  401164:	89 10                	mov    %edx,(%rax)	;1st=7-1st
  401166:	48 83 c0 04          	add    $0x4,%rax
  40116a:	48 39 f0             	cmp    %rsi,%rax
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>
  40116f:	be 00 00 00 00       	mov    $0x0,%esi
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>;
					;rdx is like a linklist      
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx
  40117a:	83 c0 01             	add    $0x1,%eax
  40117d:	39 c8                	cmp    %ecx,%eax
  40117f:	75 f5                	jne    401176 <phase_6+0x82>
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
					;if    ipt[i]=0 jump here
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx;
					;*($rsp+20+8*i)=0x6032d0+0x10*(6-ipt[i])
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7>
					;big loop init esi=i
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx ;ecx=7-ipt[i]
...
;it seems that there is a potin array in addr($rsp+0x20)
  ...
  4011ba:	48 89 d9             	mov    %rbx,%rcx  
					;loop
  4011bd:	48 8b 10             	mov    (%rax),%rdx   ;rax=rdx=&p[1+i]
...
000000000040145c <read_six_numbers>:
  ...
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax ;rax=rsi+10
  401474:	48 89 04 24          	mov    %rax,(%rsp)     ;*rsp=rsi+10
